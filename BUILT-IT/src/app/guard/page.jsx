...
export default function GuardDashboard() {
            ...
            <div className="p-8 text-center">
              <div className="mb-6 flex justify-center">
                <div className="bg-blue-100 p-4 rounded-full">
                  <ClipboardCheckIcon className="w-12 h-12 text-blue-600" />
                </div>
              </div>
  ...
  return (
    <div className={`min-h-screen ${bgClass}`}>
      ...
      {/* Guard Cards - Modified to have only 2 per row */}
            ...
            >
              ...
              >
                ...
                <div className="flex justify-between items-start mb-4">
                  <div className={`${card.iconBg} ${card.iconColor} p-3 rounded-xl shadow`}>
                    {card.icon}
                  </div>
                  <ChevronRightIcon className="w-5 h-5 text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity" />
                </div>
                
                <h3 className={`text-xl font-semibold mb-3 ${textColors.title}`}>
                  {card.title}
                </h3>
